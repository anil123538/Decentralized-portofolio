...
const Projects = ({state}) => {
        ...
        <section className="project-section">
            ...
            <div className="card-wrapper">
                 {projects!=="" && projects.map((project)=>{
                    const githubLink=`https://github.com/anil123538/${project.githunlink}`
                    return ( <a href= {githubLink} className="project-card" target='_blank' rel="noopener noreferrer" >
                    <div className="card-img">
                        <img src={`https://beige-central-catfish-885.mypinata.cloud/ipfs/${project.image}`} alt="" /></div>
 ...
 <Modal size='md' isOpen={modal} toggle={() => setModal(!modal)}>
                    ...
                    {/*  =========popup bootstrap end==========  */}
                    <p className='donate' onClick={() => setModal(true)}>If you like my projects,you can donate me ether here <FaDonate className='icon' /></p>
        </section>
    )
}
